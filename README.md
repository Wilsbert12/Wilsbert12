# Hi there, I'm Wilsbert 👋

## 🚀 Career Changer | SaaS Sales → Data Science, Data Analytics & MLOps

After 6.5+ years in SaaS sales at companies like **Salesforce**, I've made a strategic pivot into Data Analytics, Data Science and Machine Learning Operations. My journey from zero coding experience — through building Tableau Dashboards and Stories to deploying production ML systems — has been challenging but incredibly rewarding!
...
### 📊 AI Job Market — Tableau Story
**Interactive data story with 3 audience-specific dashboards**
- EDA and data cleaning / enrichment using Python and derived calculated fields
- Dashboard 1 (Career Changers): interactive scatter plot highlighting the "Sweet Spot" quadrant, balancing automation risk and median salary, with a ranked results table
...
🔧 **End-to-End Thinker**: Experience spanning the complete data lifecycle — from business question and EDA through BI and visualisation to production ML deployment
...
---
⚡ **Fun fact**: I went from closing software deals to deploying ML models and analysing data - turns out both require understanding the customer's problem and delivering the right solution!
